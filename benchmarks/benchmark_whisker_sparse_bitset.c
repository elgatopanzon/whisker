...
#define INTERSECT_1M_SPARSE_SIMD_2(name, bs_arr) \
UBENCH_F(bitset_intersect_1m_ultrasparse_2, name) \
{ \
	uint64_t count = 0; \
	struct w_sparse_bitset *a = &ubench_fixture->bs_arr[0]; \
...
#define INTERSECT_1M_SPARSE_SIMD_3(name, bs_arr) \
UBENCH_F(bitset_intersect_1m_ultrasparse_3, name) \
{ \
	uint64_t count = 0; \
	struct w_sparse_bitset *bs[3] = {&ubench_fixture->bs_arr[0], &ubench_fixture->bs_arr[1], &ubench_fixture->bs_arr[2]}; \
	...
	{ \
		...
		{ \
			...
			for (uint32_t w = simd_first; w < simd_last; w += 4) { \
				...
				__m256i v1 = _mm256_loadu_si256((__m256i*)&bs[1]->pages[page_index].bits[w]); \
				__m256i v2 = _mm256_loadu_si256((__m256i*)&bs[2]->pages[page_index].bits[w]); \
				__m256i vr = _mm256_and_si256(_mm256_and_si256(v0, v1), v2); \
				uint64_t r0 = _mm256_extract_epi64(vr, 0); \
				uint64_t r1 = _mm256_extract_epi64(vr, 1); \
				uint64_t r2 = _mm256_extract_epi64(vr, 2); \
				uint64_t r3 = _mm256_extract_epi64(vr, 3); \
...
#define INTERSECT_1M_SPARSE_SIMD_5(name, bs_arr) \
UBENCH_F(bitset_intersect_1m_ultrasparse_5, name) \
{ \
	uint64_t count = 0; \
	struct w_sparse_bitset *bs[5] = {&ubench_fixture->bs_arr[0], &ubench_fixture->bs_arr[1], &ubench_fixture->bs_arr[2], &ubench_fixture->bs_arr[3], &ubench_fixture->bs_arr[4]}; \
	...
	{ \
		...
		{ \
			...
			for (uint32_t w = simd_first; w < simd_last; w += 4) { \
				...
				__m256i v1 = _mm256_loadu_si256((__m256i*)&bs[1]->pages[page_index].bits[w]); \
				__m256i v2 = _mm256_loadu_si256((__m256i*)&bs[2]->pages[page_index].bits[w]); \
				__m256i v3 = _mm256_loadu_si256((__m256i*)&bs[3]->pages[page_index].bits[w]); \
				__m256i v4 = _mm256_loadu_si256((__m256i*)&bs[4]->pages[page_index].bits[w]); \
				__m256i vr = _mm256_and_si256(_mm256_and_si256(_mm256_and_si256(_mm256_and_si256(v0, v1), v2), v3), v4); \
				uint64_t r0 = _mm256_extract_epi64(vr, 0); \
				uint64_t r1 = _mm256_extract_epi64(vr, 1); \
				uint64_t r2 = _mm256_extract_epi64(vr, 2); \
				uint64_t r3 = _mm256_extract_epi64(vr, 3); \
...
#define INTERSECT_1M_LOW_SPARSE_SIMD_2(name, bs_arr) \
UBENCH_F(bitset_intersect_1m_low_2, name) \
{ \
	uint64_t count = 0; \
	struct w_sparse_bitset *a = &ubench_fixture->bs_arr[0]; \
...
#define INTERSECT_1M_LOW_SPARSE_SIMD_3(name, bs_arr) \
UBENCH_F(bitset_intersect_1m_low_3, name) \
{ \
	uint64_t count = 0; \
	struct w_sparse_bitset *bs[3] = {&ubench_fixture->bs_arr[0], &ubench_fixture->bs_arr[1], &ubench_fixture->bs_arr[2]}; \
...
#define INTERSECT_1M_LOW_SPARSE_SIMD_5(name, bs_arr) \
UBENCH_F(bitset_intersect_1m_low_5, name) \
{ \
	uint64_t count = 0; \
	struct w_sparse_bitset *bs[5] = {&ubench_fixture->bs_arr[0], &ubench_fixture->bs_arr[1], &ubench_fixture->bs_arr[2], &ubench_fixture->bs_arr[3], &ubench_fixture->bs_arr[4]}; \
...
#define INTERSECT_1M_HIGH_SPARSE_SIMD_2(name, bs_arr) \
UBENCH_F(bitset_intersect_1m_high_2, name) \
{ \
	uint64_t count = 0; \
	struct w_sparse_bitset *a = &ubench_fixture->bs_arr[0]; \
...
#define INTERSECT_1M_HIGH_SPARSE_SIMD_3(name, bs_arr) \
UBENCH_F(bitset_intersect_1m_high_3, name) \
{ \
	uint64_t count = 0; \
	struct w_sparse_bitset *bs[3] = {&ubench_fixture->bs_arr[0], &ubench_fixture->bs_arr[1], &ubench_fixture->bs_arr[2]}; \
...
#define INTERSECT_1M_HIGH_SPARSE_SIMD_5(name, bs_arr) \
UBENCH_F(bitset_intersect_1m_high_5, name) \
{ \
	uint64_t count = 0; \
	struct w_sparse_bitset *bs[5] = {&ubench_fixture->bs_arr[0], &ubench_fixture->bs_arr[1], &ubench_fixture->bs_arr[2], &ubench_fixture->bs_arr[3], &ubench_fixture->bs_arr[4]}; \
