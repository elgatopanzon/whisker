...
// init an instance of a managed array with type unsigned int
...
// deallocate an instance of a managed array with type unsigned int
...
// resize a managed array of type unsigned int
...
// push a unsigned int value into the array, resizing and re-allocating if required
...
// pop the last unsigned int value from the array, decreasing the managed length
...
// swap 2 unsigned int values with the given indexes using the swap buffer
...
// get the index of the unsigned int value, -1 if it doesn't exist
