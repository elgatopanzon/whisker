...
#ifndef WHISKER_GENERIC_BLOCK_ARRAY_whisker_ecs_entity_deferred_action_H
#define WHISKER_GENERIC_BLOCK_ARRAY_whisker_ecs_entity_deferred_action_H

typedef struct whisker_block_arr_whisker_ecs_entity_deferred_action
{
	whisker_arr_void_ *blocks;
	size_t block_size;
} whisker_block_arr_whisker_ecs_entity_deferred_action;

E_WHISKER_BLOCK_ARR whisker_block_arr_create_whisker_ecs_entity_deferred_action(whisker_block_arr_whisker_ecs_entity_deferred_action **arr, size_t block_size);
