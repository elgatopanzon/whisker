...
#ifndef WHISKER_GENERIC_BLOCK_ARRAY_float_H
#define WHISKER_GENERIC_BLOCK_ARRAY_float_H

typedef struct whisker_block_arr_float
{
	whisker_arr_void_ *blocks;
	size_t block_size;
} whisker_block_arr_float;

E_WHISKER_BLOCK_ARR whisker_block_arr_create_float(whisker_block_arr_float **arr, size_t block_size);
