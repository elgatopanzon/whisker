...
#ifndef WHISKER_GENERIC_ARRAY_unsigned_long_long_H
#define WHISKER_GENERIC_ARRAY_unsigned_long_long_H

typedef struct whisker_arr_unsigned_long_long
{
	unsigned long long *arr;
	size_t length;
	size_t alloc_size;
	unsigned long long swap_buffer;
} whisker_arr_unsigned_long_long;
