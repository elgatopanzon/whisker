...
#ifndef WHISKER_GENERIC_BLOCK_ARRAY_whisker_ecs_entity_index_H
#define WHISKER_GENERIC_BLOCK_ARRAY_whisker_ecs_entity_index_H

typedef struct whisker_block_arr_whisker_ecs_entity_index
{
	whisker_arr_void_ *blocks;
	size_t block_size;
} whisker_block_arr_whisker_ecs_entity_index;

E_WHISKER_BLOCK_ARR whisker_block_arr_create_whisker_ecs_entity_index(whisker_block_arr_whisker_ecs_entity_index **arr, size_t block_size);
