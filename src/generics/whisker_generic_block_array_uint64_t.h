...
#ifndef WHISKER_GENERIC_BLOCK_ARRAY_uint64_t_H
#define WHISKER_GENERIC_BLOCK_ARRAY_uint64_t_H

typedef struct whisker_block_arr_uint64_t
{
	whisker_arr_void_ *blocks;
	size_t block_size;
} whisker_block_arr_uint64_t;

E_WHISKER_BLOCK_ARR whisker_block_arr_create_uint64_t(whisker_block_arr_uint64_t **arr, size_t block_size);
