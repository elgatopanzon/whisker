...
#ifndef WHISKER_GENERIC_BLOCK_ARRAY_unsigned_short_H
#define WHISKER_GENERIC_BLOCK_ARRAY_unsigned_short_H

typedef struct whisker_block_arr_unsigned_short
{
	whisker_arr_void_ *blocks;
	size_t block_size;
} whisker_block_arr_unsigned_short;

E_WHISKER_BLOCK_ARR whisker_block_arr_create_unsigned_short(whisker_block_arr_unsigned_short **arr, size_t block_size);
