...
#ifndef WHISKER_GENERIC_BLOCK_ARRAY_int_H
#define WHISKER_GENERIC_BLOCK_ARRAY_int_H

typedef struct whisker_block_arr_int
{
	whisker_arr_void_ *blocks;
	size_t block_size;
} whisker_block_arr_int;

E_WHISKER_BLOCK_ARR whisker_block_arr_create_int(whisker_block_arr_int **arr, size_t block_size);
