...
#ifndef WHISKER_GENERIC_BLOCK_ARRAY_short_H
#define WHISKER_GENERIC_BLOCK_ARRAY_short_H

typedef struct whisker_block_arr_short
{
	whisker_arr_void_ *blocks;
	size_t block_size;
} whisker_block_arr_short;

E_WHISKER_BLOCK_ARR whisker_block_arr_create_short(whisker_block_arr_short **arr, size_t block_size);
