...
#ifndef WHISKER_GENERIC_BLOCK_ARRAY_unsigned_char_H
#define WHISKER_GENERIC_BLOCK_ARRAY_unsigned_char_H

typedef struct whisker_block_arr_unsigned_char
{
	whisker_arr_void_ *blocks;
	size_t block_size;
} whisker_block_arr_unsigned_char;

E_WHISKER_BLOCK_ARR whisker_block_arr_create_unsigned_char(whisker_block_arr_unsigned_char **arr, size_t block_size);
