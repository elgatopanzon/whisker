...
#ifndef WHISKER_GENERIC_BLOCK_ARRAY_long_double_H
#define WHISKER_GENERIC_BLOCK_ARRAY_long_double_H

typedef struct whisker_block_arr_long_double
{
	whisker_arr_void_ *blocks;
	size_t block_size;
} whisker_block_arr_long_double;

E_WHISKER_BLOCK_ARR whisker_block_arr_create_long_double(whisker_block_arr_long_double **arr, size_t block_size);
