...
#ifndef WHISKER_GENERIC_BLOCK_ARRAY_unsigned_int_H
#define WHISKER_GENERIC_BLOCK_ARRAY_unsigned_int_H

typedef struct whisker_block_arr_unsigned_int
{
	whisker_arr_void_ *blocks;
	size_t block_size;
} whisker_block_arr_unsigned_int;

E_WHISKER_BLOCK_ARR whisker_block_arr_create_unsigned_int(whisker_block_arr_unsigned_int **arr, size_t block_size);
