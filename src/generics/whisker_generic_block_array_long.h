...
#ifndef WHISKER_GENERIC_BLOCK_ARRAY_long_H
#define WHISKER_GENERIC_BLOCK_ARRAY_long_H

typedef struct whisker_block_arr_long
{
	whisker_arr_void_ *blocks;
	size_t block_size;
} whisker_block_arr_long;

E_WHISKER_BLOCK_ARR whisker_block_arr_create_long(whisker_block_arr_long **arr, size_t block_size);
