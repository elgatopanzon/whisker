...
#ifndef WHISKER_GENERIC_ARRAY_uint16_t_H
#define WHISKER_GENERIC_ARRAY_uint16_t_H

typedef struct whisker_arr_uint16_t
{
	uint16_t *arr;
	size_t length;
	size_t alloc_size;
	uint16_t swap_buffer;
} whisker_arr_uint16_t;
