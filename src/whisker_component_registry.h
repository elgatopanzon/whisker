...
#ifndef W_COMPONENT_REGISTRY_ENTRY_BITSET_PAGE_SHIFT
#define W_COMPONENT_REGISTRY_ENTRY_BITSET_PAGE_SHIFT 6
#endif /* ifndef W_COMPONENT_REGISTRY_ENTRY_BITSET_PAGE_SHIFT */

#ifndef W_COMPONENT_REGISTRY_DATA_BITSET_PAGE_SHIFT
#define W_COMPONENT_REGISTRY_DATA_BITSET_PAGE_SHIFT 8
#endif /* ifndef W_COMPONENT_REGISTRY_DATA_BITSET_PAGE_SHIFT */
...
enum W_COMPONENT_TYPE { 
	...
	W_COMPONENT_TYPE_w_vec2i = 21,
	W_COMPONENT_TYPE_w_vec2u = 22,
	W_COMPONENT_TYPE_w_vec3 = 23,
	W_COMPONENT_TYPE_w_vec3i = 24,
	W_COMPONENT_TYPE_w_vec3u = 25,
	W_COMPONENT_TYPE_w_vec4 = 26,
	W_COMPONENT_TYPE_w_vec4i = 27,
	W_COMPONENT_TYPE_w_vec4u = 28,

	W_COMPONENT_TYPE_w_mat2 = 29,
	W_COMPONENT_TYPE_w_mat3 = 30,
	W_COMPONENT_TYPE_w_mat4 = 31,

	W_COMPONENT_TYPE_w_color = 32,
	W_COMPONENT_TYPE_w_color8 = 33,

	W_COMPONENT_TYPE_w_rect = 34,
	W_COMPONENT_TYPE_w_recti = 35,
	W_COMPONENT_TYPE_w_aabb2 = 36,
	W_COMPONENT_TYPE_w_aabb3 = 37,
	W_COMPONENT_TYPE_w_ray2 = 38,
	W_COMPONENT_TYPE_w_ray3 = 39,
...
static const char *w_component_type_names[W_COMPONENT_TYPE_COUNT] = {
	...
	[W_COMPONENT_TYPE_w_vec3]      = "w_vec3",
	[W_COMPONENT_TYPE_w_vec3i]     = "w_vec3i",
	[W_COMPONENT_TYPE_w_vec3u]     = "w_vec3u",
	[W_COMPONENT_TYPE_w_vec4]      = "w_vec4",
	[W_COMPONENT_TYPE_w_vec4i]     = "w_vec4i",
	[W_COMPONENT_TYPE_w_vec4u]     = "w_vec4u",
	[W_COMPONENT_TYPE_w_mat2]      = "w_mat2",
	[W_COMPONENT_TYPE_w_mat3]      = "w_mat3",
	[W_COMPONENT_TYPE_w_mat4]      = "w_mat4",
	[W_COMPONENT_TYPE_w_color]     = "w_color",
	[W_COMPONENT_TYPE_w_color8]    = "w_color8",
	[W_COMPONENT_TYPE_w_rect]      = "w_rect",
	[W_COMPONENT_TYPE_w_recti]     = "w_recti",
	[W_COMPONENT_TYPE_w_aabb2]     = "w_aabb2",
	[W_COMPONENT_TYPE_w_aabb3]     = "w_aabb3",
	[W_COMPONENT_TYPE_w_ray2]      = "w_ray2",
	[W_COMPONENT_TYPE_w_ray3]      = "w_ray3",
...
static const size_t w_component_type_sizes[W_COMPONENT_TYPE_COUNT] = {
	...
	[W_COMPONENT_TYPE_w_vec3]      = sizeof(w_vec3),
	[W_COMPONENT_TYPE_w_vec3i]     = sizeof(w_vec3i),
	[W_COMPONENT_TYPE_w_vec3u]     = sizeof(w_vec3u),
	[W_COMPONENT_TYPE_w_vec4]      = sizeof(w_vec4),
	[W_COMPONENT_TYPE_w_vec4i]     = sizeof(w_vec4i),
	[W_COMPONENT_TYPE_w_vec4u]     = sizeof(w_vec4u),
	[W_COMPONENT_TYPE_w_mat2]      = sizeof(w_mat2),
	[W_COMPONENT_TYPE_w_mat3]      = sizeof(w_mat3),
	[W_COMPONENT_TYPE_w_mat4]      = sizeof(w_mat4),
	[W_COMPONENT_TYPE_w_color]     = sizeof(w_color),
	[W_COMPONENT_TYPE_w_color8]    = sizeof(w_color8),
	[W_COMPONENT_TYPE_w_rect]      = sizeof(w_rect),
	[W_COMPONENT_TYPE_w_recti]     = sizeof(w_recti),
	[W_COMPONENT_TYPE_w_aabb2]     = sizeof(w_aabb2),
	[W_COMPONENT_TYPE_w_aabb3]     = sizeof(w_aabb3),
	[W_COMPONENT_TYPE_w_ray2]      = sizeof(w_ray2),
	[W_COMPONENT_TYPE_w_ray3]      = sizeof(w_ray3),
