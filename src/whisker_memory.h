...
void w_mem_register_alloc_failed_callback(w_mem_alloc_panic_func alloc_failed_func, void *alloc_panic_func_arg);
...
#define w_mem_xcalloc(count, size) w_mem_xcalloc_(count, size, __LINE__, __FILE__, alloc_warning_callback_arg_, alloc_warning_callback_, alloc_panic_callback_, alloc_panic_callback_arg_)
#define w_mem_xrealloc(ptr, size) w_mem_xrealloc_(ptr, size, __LINE__, __FILE__, alloc_warning_callback_arg_, alloc_warning_callback_, alloc_panic_callback_, alloc_panic_callback_arg_)
