...
START_TEST(test_whisker_ecs_component_get_and_set)
{
	...
	*uint_e3 = 3;
	...
	uint64_t *ca = c->components[component_id.index];
	ca[e1.index] = 1;
	ca[e2.index] = 2;
