...
{
	whisker_ecs_entities *entities = whisker_ecs_e_create_and_init_entities();
	...
	// free
	whisker_ecs_e_free_entities_all(entities);
}
END_TEST
...
START_TEST(test_whisker_ecs_entity_create_destroy_and_recycle)
{
	...
	whisker_ecs_entity_id e1 = whisker_ecs_e_create_(entities);
	whisker_ecs_entity_id e2 = whisker_ecs_e_create_(entities);
	whisker_ecs_entity_id e3 = whisker_ecs_e_create_(entities);
	...
	whisker_ecs_entity_id e4 = whisker_ecs_e_create_(entities);
...
START_TEST(test_whisker_ecs_create_and_set_entity_name)
{
	...
	whisker_ecs_entity_id e1 = whisker_ecs_e_create_named_(entities, "e1");
	whisker_ecs_entity_id e2 = whisker_ecs_e_create_named_(entities, "e2");
	whisker_ecs_entity_id e3 = whisker_ecs_e_create_named_(entities, "e3");
	...
	whisker_ecs_entity_id e4 = whisker_ecs_e_create_named_(entities, "e3");
	ck_assert_uint_eq(2, e4.index);
...
START_TEST(test_whisker_ecs_entity_named_entities_to_id)
{
	...
	whisker_ecs_entities *en = whisker_ecs_e_create_and_init_entities();

	// create archetype from named entities
	struct whisker_ecs_entity_id_array *a1 = whisker_ecs_e_from_named_entities(en, "test1,test2");
	...
	struct whisker_ecs_entity_id_array *a2 = whisker_ecs_e_from_named_entities(en, "test1,test2");
	...
	whisker_ecs_entity_id e3 = whisker_ecs_e_create_named_(en, "test3");
	whisker_ecs_entity_id e4 = whisker_ecs_e_create_named_(en, "test4");

	// create new archetype from the named entities
	struct whisker_ecs_entity_id_array *a3 = whisker_ecs_e_from_named_entities(en, "test3,test4,test1");
	...
	// free
	whisker_ecs_e_free_entities_all(en);
	free(a1->arr);
	free(a2->arr);
	free(a3->arr);
	free(a1);
